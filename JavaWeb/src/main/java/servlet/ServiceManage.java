    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(op==1) {
            ...
            if(isIDexists(id)){
                ...
                System.out.println(id+"existe, est un ancien client");
                discount= searchDiscount(id) ;
                System.out.println("la remise est"+discount);
            }else {
                
                System.out.println(id+"n'existe pas, est un nouveau client");
            ...
            Order order =new Order(orderNumber,"Enregistré",map.get("idcard")[0],
